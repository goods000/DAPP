<template>
	<view class="pages">
		<view class="main">
			...
			<!-- 销毁记录 -->
			<openDestoryRecord ref="openDestoryRecord"  @openPopup="openPopup"/>
			<!-- 自主销毁明细 -->
			<openDetail ref="openDetail" :chooseItemInfo="chooseItemInfo" />
		</view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		openPopup(e,item) {
			console.log("e",item);
			if (typeof e == 'string') {
				if (e == 'openPledgeRecordDetails' || e == 'openDetail') {
