			...
			<view class="headerTop">
				<view class="initTabs">
					<view class="initTabs-control">
						<view class="initTabs-control__item" :class="{'initTabs-control__item--active' : tabActive == 0}" @click="changeTabsActive(0)">{{ i18n.list.tabTitle01 }}</view>
						<view class="initTabs-control__item" :class="{'initTabs-control__item--active' : tabActive == 1}" @click="changeTabsActive(1)">{{ i18n.list.tabTitle02 }}</view>
						<view class="initTabs-control__item" :class="{'initTabs-control__item--active' : tabActive == 2}" @click="changeTabsActive(2)">{{ i18n.list.tabTitle03 }}</view>
					</view>
				</view>
				<!-- 世界数据 -->
				<view class="listData">
					<view class="listData-wrapper">
						<view class="listData-headerImage">
							<image class="listData-headerImage__listHeader" v-if="tabActive == 0" :src="require(`@/static/list/icon-worldData-headerTitle-${$store.state.initLanguage}.png`)" mode="widthFix"></image>
							<image class="listData-headerImage__listHeader" v-if="tabActive == 1" :src="require(`@/static/list/icon-factionalData-headerTitle-${$store.state.initLanguage}.png`)" mode="widthFix"></image>
							<image class="listData-headerImage__listHeader" v-if="tabActive == 2" :src="require(`@/static/list/icon-worldList-headerTitle-${$store.state.initLanguage}.png`)" mode="widthFix"></image>
