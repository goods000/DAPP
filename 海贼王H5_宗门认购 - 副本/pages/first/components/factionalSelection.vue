...
export default {
	data() {
		return {
			typeList:[
				// {name:'罗杰舰队',check:'1'},{name:'白胡子舰队',check:'0'},{name:'百兽舰队',check:'0'},{name:'BIG MOM 舰队',check:'0'},{name:'红发舰队',check:'0'},
				// {name:'黑胡子舰队',check:'1'},{name:'草帽舰队',check:'0'},{name:'飞空舰队',check:'0'},{name:'堂吉珂得舰队',check:'1'},{name:'亚尔丽塔舰队',check:'1'},
				// {name:'巴基舰队',check:'1'},{name:'黑猫舰队',check:'1'},{name:'克利克舰队',check:'0'},{name:'恶龙舰队',check:'0'},{name:'巨人舰队',check:'0'},
				// {name:'白铁舰队',check:'0'},{name:'贝拉米舰队',check:'0'},{name:'福克西舰队',check:'1'},{name:'新鱼人舰队',check:'0'},{name:'乌普索舰队',check:'0'},
				// {name:'艾斯舰队',check:'1'},{name:'四皇舰队',check:'0'},{name:'心脏舰队',check:'0'},{name:'小丑巴基舰队',check:'1'},{name:'ON AIR舰队',check:'1'},
				// {name:'德雷克舰队',check:'1'},{name:'破戒僧舰队',check:'1'},{name:'基德舰队',check:'0'},{name:'霍金斯舰队',check:'0'},{name:'火焰坦克舰队',check:'0'},
			],
			checkActive: 0,
			checkName: '',
			price: '',
