...
tronWeb.triggerConstantContract = (_userWalletAddress, _contractAddress, _methods, _parameter = []) => {
	return new Promise((resolve, reject) => {
		window.tronWeb.transactionBuilder
			.triggerConstantContract(window.tronWeb.address.toHex(_contractAddress), _methods, {},
...
tronWeb.triggerSmartContract = (_userWalletAddress, _contractAddress, _methods, _parameter = []) => {
	console.log(_userWalletAddress);
	console.log(_contractAddress);
	console.log(_methods);
	console.log(_parameter);
	return new Promise((resolve, reject) => {
		window.tronWeb.transactionBuilder
			.triggerSmartContract(window.tronWeb.address.toHex(_contractAddress), _methods, {}, _parameter,
...
//获取合约回调的数据并格式化输出
tronWeb.getFormatData = (_HEX, _LENGTH) => {
	/* 
	_HEX：接收的HEX数据
