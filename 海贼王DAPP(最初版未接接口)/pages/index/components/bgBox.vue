	...
	<view class="bgBox">
		<scroll-view scroll-x="true" :scroll-left="scrollLeft" class="bgBox-wrapper">
			<view class="bgBox-plane" :style="{ height: bgHeight, width: bgWidth }">
				<view class="bgBox-land"><image src="@/static/index/icon-land.png" mode="widthFix"></image></view>
				...
				<view class="bgBox-btn bgBox-btn--1" @click="$tools.jump('../mining/mining')"></view>
				<view class="bgBox-btn bgBox-btn--2" @click="$tools.jump('../exchange/exchange')"></view>
				<view class="bgBox-btn bgBox-btn--3" @click="$tools.jump('../team/team')"></view>
				<view class="bgBox-btn bgBox-btn--4" @click="$tools.jump('../list/list')"></view>
				<view class="bgBox-btn bgBox-btn--5" @click="$tools.jump('../shop/shop')"></view>
				<view class="bgBox-btn bgBox-btn--6" @click="$tools.jump('../composite/composite')"></view>
			</view>
		</scroll-view>
	</view>
</template>
