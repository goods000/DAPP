...
const store = new Vuex.Store({
	state: {
		...
		usdtContractDecimal: 6, //USDT的精度
		// platmentContractAddress: 'TJo5vJFgi2HF9YnH6tfYptaaYncWSVWqiX', //HBIC平台币合约地址
		// platmentContractDecimal: 8,
		platmentContractAddress: 'TMq8Z632ZwHiHHRBXE8haXtSbQtB5ReTw3', //HBIC平台币合约地址
		platmentContractDecimal: 18,
		...
		gangContractAddress: 'TVfWKHdtNjcQ4eRSoiaXHJNReQST6U4Mza', //宗门认购收款地址
		blindboxContractAddress: "TXao5aAM87r9DVppXT4qxWX4o8FqVRzBiu", // 盲盒购买收款地址
		
		/* 测试合约地址 */
		// usdtContractAddress: 'TH2hJ3jqcn6RtPGk3F2aqeA1fxpnD8EC4C', //USDT合约地址
		// usdtContractDecimal: 8, //USDT的精度
		// platmentContractAddress: 'TLLDQoqTVXaENjZMyLi9p2ESXRRBK4Tj5z', //HBIC平台币合约地址
		// platmentContractDecimal: 8,
		// feeContractAddress: "TXR3F4BsmH1eMeujvAgThcivpqonrpRfkA", // 手续费收款地址
		// feeContractDecimal: 6,  // 手续费
