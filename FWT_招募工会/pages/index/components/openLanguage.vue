			...
			<view class="popupBox-languageBg">
				<view class="popupBox-container">
					<view class="popupBox-header">
						<image class="popupBox-header__image" :src="$store.state.initLanguage == 'en' ? '../../static/index/icon-open-langTitle-en.png' : '../../static/index/icon-open-langTitle.png'" mode="widthFix"></image>
					</view>
