			...
			<view class="popupBox-wrapper">
				...
				<view class="popupBox-container">
					...
					<view class="popupBox-contentbg">
						...
						<view class="popupBox-contentbg__item">
							<view class="popupBox-contentbg__item-info">{{ i18n.index.openPledgeRecordDetails.tips02 }}({{ $store.state.platmentCurrencyName }})：</view>
						...
						<view class="popupBox-contentbg__item">
							<view class="popupBox-contentbg__item-info">{{ i18n.index.openPledgeRecordDetails.tips03 }}({{ $store.state.platmentCurrencyName }})：</view>
					...
					<view class="failureRecord-itemBox">
						...
						<scroll-view class="failureRecord-height" :scroll-y="true" :show-scrollbar="false">
							...
							<view class="failureRecord-itemHeader" v-for="(item, index) in recordList" :key="index">
								...
								<view class="failureRecord-itemHeader__content">{{ item[0].toFixed(6) }}</view>
							</view>
						</scroll-view>
					</view>
			...
			this.$tronWeb
				 ...
				 */
					...
					this.recordList.forEach((item, index) => {
						item[0] = item[0] / Math.pow(10, this.$store.state.HBICContractDecimal);
					});
				});
		},
